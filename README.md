...
- **Scope**: Focus on the latest dataset only; historicaion of data is not required.
- **Documentation**: Provide clear documentation of the data model to support both business stakeholders nd analystics team. 
